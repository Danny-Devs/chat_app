...
const CollapsibleMessage: React.FC<CollapsibleMessageProps> = ({
  ...
  return (
    <div className="mb-2 border-b border-gray-200 dark:border-gray-700">
      <div
        className="flex items-center cursor-pointer p-2 hover:bg-gray-50 dark:hover:bg-gray-800"
      ...
      {isExpanded && (
        <pre className="p-2 pl-8 text-sm text-gray-600 dark:text-gray-300 whitespace-pre-wrap">
          {message.content}
        </pre>
      )}
    </div>
...
export const DebugPanel: React.FC<DebugPanelProps> = ({ context = [] }) => {
  return (
    <div className="h-full bg-white dark:bg-gray-900 text-gray-900 dark:text-white p-4 overflow-auto">
